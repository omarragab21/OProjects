...
class TaskScreenLayout extends StatelessWidget {
   TaskScreenLayout({ Key? key }) : super(key: key);
  @override
    ...
    return GetBuilder<TasksController>(
      ...
      builder:(taskss)=> Container(
        child: ConditionalBuilder(
          condition: taskss.dailyTasks.length > 0, 
          builder: (context)=>ListView.separated(itemBuilder: (context,i)=>taskItemWidget(taskss.dailyTasks[i],context), 
          separatorBuilder: (context,i)=>const SizedBox(height: 20,), 
          itemCount: taskss.dailyTasks.length), 
            ...
            children: [
              ...
              const SizedBox(height: 10,),
               ...
               TextButton(onPressed: (){
                ...
                child: Center(child: Text('Done Task ',style: TextStyle(color: Colors.white),),),
